...
def create_CIS_major():
    ...
    CIS_major.add_course("CIS 110 Fluency with Information Technology", 110, 4, [], [Term("Fall")])
    ...
    CIS_major.add_course("CIS 313 Intermediate Data Structures", 313, 4, ["CIS 210 Computer Science I", "CIS 211 Computer Science II", "CIS 212 Computer Science III", "MATH 231 Elements of Discrete Mathematics I", "MATH 232 Elements of Discrete Mathematics II"], [Term("Fall"), Term("Winter")], is_core = True)
    CIS_major.add_course("CIS 314 Computer Organization", 314, 4, ["CIS 210 Computer Science I", "CIS 211 Computer Science II", "CIS 212 Computer Science III", "MATH 231 Elements of Discrete Mathematics I"], [Term("Winter"), Term("Spring")], is_core = True)
    ...
    CIS_major.add_course("CIS 399 Applied Cryptography", 399, 4, ["CIS 212 Computer Science III"], [Term("Winter")])
