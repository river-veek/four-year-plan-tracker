...
def create_CIS_major():
    ...
    CIS_major.add_course("WR 122 College Composition II", 122, 4, ["WR 121 College Composition I"], [Term("Fall"), Term("Winter"), Term("Spring"), Term("Summer")], is_core = True)
    ...
    # There are multiple CIS 199 offerings, not at of which are identified on the UO website
    # Similarly to CIS 399, UO offers different variations of CIS 199 that are consistently changing
    # Hence, this system handles the course similarly to electives and assumes the user
    # will keep track of which specific offering they're interested in taking (or have taken)
    CIS_major.add_course("CIS 199 Option", 199, 4, [], [Term("Fall"), Term("Winter"), Term("Spring"), Term("Summer")])
    ...
    # --------------------------------------------------------------------------
    CIS_major.add_course("CIS 313 Intermediate Data Structures", 313, 4, ["CIS 212 Computer Science III", "MATH 232 Elements of Discrete Mathematics II"], [Term("Fall"), Term("Winter")], is_core = True)
    CIS_major.add_course("CIS 314 Computer Organization", 314, 4, ["CIS 212 Computer Science III", "MATH 231 Elements of Discrete Mathematics I"], [Term("Winter"), Term("Spring")], is_core = True)
    ...
    CIS_major.add_course("CIS 322 Introduction to Software Engineering", 322, 4, ["CIS 212 Computer Science III"], [Term("Fall"), Term("Spring")])
    CIS_major.add_course("CIS 330 C/C++ & Unix", 330, 4, ["CIS 314 Computer Organization"], [Term("Winter"), Term("Spring")], is_core = True)

    # There are multiple CIS 399 offerings. Since there is no definitive list on
    # the UO website, this system handles the course similarly to electives and
    # assumes the user will keep track of which specific offering they're
    # interested in taking (or have taken)
    CIS_major.add_course("CIS 399 Option", 399, 4, ["CIS 212 Computer Science III"], [Term("Fall"), Term("Winter"), Term("Spring"), Term("Summer")])
    # --------------------------------------------------------------------------
